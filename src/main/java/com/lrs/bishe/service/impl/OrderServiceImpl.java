...
import com.lrs.bishe.dao.OrderDao;
...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    public List<Order> queryByHouseIdAndUserId(Integer houseId,Integer userId) {
        return orderDao.queryByHouseIdAndUserId(houseId,userId);
    }
